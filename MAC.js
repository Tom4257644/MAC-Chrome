...
function resetGame() {
    ...
    // Reset high score and average time for high score
    highScore = 0;
...
function getRandomNumber(a) {
    if (a == 4 || a == 3){
        ...
        switch(type) {
            ...
            case 2: return (Math.random() * 25).toFixed(2); // Two decimal places
            case 3: return (Math.random() * 25).toFixed(2); // Two decimal places
        }}
        else{
            switch(a) {
                case 0: return Math.floor(Math.random() * 10); // Integer
